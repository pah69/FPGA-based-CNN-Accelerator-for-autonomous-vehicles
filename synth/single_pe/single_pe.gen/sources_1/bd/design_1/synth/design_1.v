...
module design_1
  ...
  design_1_clk_wiz_0 clk_wiz
       (.clk_in1(clk_100MHz_1),
        ...
        .reset(reset_1));
  design_1_pe_wrapper_0_0 pe_wrapper_0
       (.acc_clear(1'b0),
        .activation_i({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .clk(clk_wiz_clk_out1),
        .rst_n(1'b0),
        .start(1'b0),
        .valid_i(1'b0),
        .weight_addr({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .weight_i({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .weight_we(1'b0));
endmodule
