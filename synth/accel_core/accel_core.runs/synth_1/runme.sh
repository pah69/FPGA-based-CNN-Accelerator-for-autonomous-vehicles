...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/synth/accel_core/accel_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_wrapper.tcl
