...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/tpu_mnist_ip/tpu_mnist_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_top_axi_lite.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tpu_top_axi_lite.tcl -notrace
