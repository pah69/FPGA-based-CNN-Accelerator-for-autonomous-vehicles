...
# Minimal TPU bring-up XDC for Zybo Z7 block-design flow.
#
# The TPU AXI-Lite bus must be internal:
#   ZYNQ7 PS M_AXI_GP0 -> AXI Interconnect/SmartConnect -> TPU S_AXI
#
# Do not constrain s_axi_* ports here. If tpu_top_axi_lite is used directly as
# the top module, Vivado will try to place the AXI-Lite bus on board pins and
# implementation will fail with too many IO ports.
#
# For the intended block design, use design_1_wrapper as top. PS DDR/FIXED_IO
# constraints are handled by the ZYNQ7 Processing System block/board preset.

#Clock signal
# No external TPU clock port in the PS block-design flow.
# FCLK_CLK0 from ZYNQ7 PS drives TPU S_AXI_ACLK internally.
