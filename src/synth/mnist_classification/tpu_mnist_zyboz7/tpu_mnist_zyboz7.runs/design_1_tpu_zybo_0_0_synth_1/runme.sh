...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/tpu_mnist_zyboz7/tpu_mnist_zyboz7.runs/design_1_tpu_zybo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_tpu_zybo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_tpu_zybo_0_0.tcl
