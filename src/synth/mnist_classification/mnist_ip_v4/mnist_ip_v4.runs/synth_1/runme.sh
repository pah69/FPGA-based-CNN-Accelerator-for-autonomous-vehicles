...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/mnist_classification/mnist_ip_v4/mnist_ip_v4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_axi_lite.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_axi_lite.tcl
