...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/sa_3x3/sa_3x3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ws_sa_3x3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ws_sa_3x3.tcl -notrace
