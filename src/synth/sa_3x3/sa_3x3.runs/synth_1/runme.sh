...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/sa_3x3/sa_3x3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ws_sa_3x3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ws_sa_3x3.tcl
