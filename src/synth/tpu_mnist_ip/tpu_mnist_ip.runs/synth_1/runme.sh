...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/tpu_mnist_ip/tpu_mnist_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_top_axi_lite.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tpu_top_axi_lite.tcl
