...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/tpu_mnist_zcu104/tpu_mnist.runs/design_1_tpu_mnist_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_tpu_mnist_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_tpu_mnist_0_0.tcl
