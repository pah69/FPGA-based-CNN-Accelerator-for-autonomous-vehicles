...
HD_PWD='/home/pah/fpga_cnn_accelerator/FPGA-based-CNN-Accelerator-for-autonomous-vehicles/src/synth/tpu_mnist/tpu_mnist.runs/design_1_tpu_mnist_0_0_synth_1'
cd "$HD_PWD"
