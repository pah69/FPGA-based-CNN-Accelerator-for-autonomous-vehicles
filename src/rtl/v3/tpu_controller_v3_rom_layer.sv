...
// ROM-backed V3 controller for one complete compute layer.
//
// This sequences the V3 ROM tile controller across spatial positions and
// output-channel tiles. The child controller owns K-tile overlap, param ROM
// lookup, VPU launch, and two-lane UB writeback for one spatial/OC tile.
module tpu_controller_v3_rom_layer #(
    ...
    output logic [31:0] dbg_tile_count_o,
  ...
  localparam logic [31:0] ERR_DESC_INVALID = 32'h0005_0001;
  localparam logic [31:0] ERR_SPATIAL      = 32'h0005_0002;
  localparam logic [31:0] ERR_TILE         = 32'h0005_0003;
  ...
  logic single_spatial_q;

  logic desc_valid_w;
  layer_type_t desc_layer_type_unused_w;
  logic [15:0] desc_in_h_unused_w;
  logic [15:0] desc_in_w_unused_w;
  logic [15:0] desc_in_ch_unused_w;
  logic [15:0] desc_out_h_unused_w;
  logic [15:0] desc_out_w_unused_w;
  logic [15:0] desc_out_ch_unused_w;
  logic [15:0] desc_kernel_h_unused_w;
  logic [15:0] desc_kernel_w_unused_w;
  logic [15:0] desc_k_total_unused_w;
  logic [15:0] desc_num_k_tiles_unused_w;
  logic [15:0] desc_num_oc_tiles_w;
  logic [15:0] desc_num_spatial_w;
  logic [15:0] desc_weight_base_unused_w;
  logic [15:0] desc_bias_base_unused_w;
  logic [15:0] desc_requant_base_unused_w;
  act_mode_t desc_act_mode_unused_w;
  logic desc_read_bank_unused_w;
  logic desc_write_bank_unused_w;

  logic last_oc_tile_w;
  logic last_spatial_w;

  layer_descriptor_rom u_layer_descriptor_rom (
      .layer_idx_i    (layer_idx_q),
      .valid_o        (desc_valid_w),
      .layer_type_o   (desc_layer_type_unused_w),
      .in_h_o         (desc_in_h_unused_w),
      .in_w_o         (desc_in_w_unused_w),
      .in_ch_o        (desc_in_ch_unused_w),
      .out_h_o        (desc_out_h_unused_w),
      .out_w_o        (desc_out_w_unused_w),
      .out_ch_o       (desc_out_ch_unused_w),
      .kernel_h_o     (desc_kernel_h_unused_w),
      .kernel_w_o     (desc_kernel_w_unused_w),
      .k_total_o      (desc_k_total_unused_w),
      .num_k_tiles_o  (desc_num_k_tiles_unused_w),
      .num_oc_tiles_o (desc_num_oc_tiles_w),
      .num_spatial_o  (desc_num_spatial_w),
      .weight_base_o  (desc_weight_base_unused_w),
      .bias_base_o    (desc_bias_base_unused_w),
      .requant_base_o (desc_requant_base_unused_w),
      .act_mode_o     (desc_act_mode_unused_w),
      .read_bank_o    (desc_read_bank_unused_w),
      .write_bank_o   (desc_write_bank_unused_w)
  );

  tpu_controller_v3_rom_tile #(
      .SIZE                   (SIZE),
  ...
  assign last_spatial_w = single_spatial_q || ((spatial_idx_q + 16'd1) >= desc_num_spatial_w);
        ...
        unique case (state_q)
          S_IDLE: begin
            ...
            if (start_i) begin
              ...
              oc_tile_q <= '0;
              single_spatial_q <= single_spatial_i;
              dbg_cycle_count_o <= '0;
              dbg_tile_count_o <= '0;
          ...
          S_START_TILE: begin
            ...
            end else if (spatial_idx_q >= desc_num_spatial_w) begin
              state_q <= S_ERROR;
              error_o <= 1'b1;
...
endmodule : tpu_controller_v3_rom_layer
