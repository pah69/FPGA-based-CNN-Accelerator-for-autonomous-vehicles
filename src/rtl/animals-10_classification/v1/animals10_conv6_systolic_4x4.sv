...
// Animals-10 Student A Conv6 through the generic SIZE=4 systolic Conv engine.
//
// Contract:
//   input  : conv5_out_i8, CHW 128x16x16
//   weight : compact Conv6 OIHW [128,128,3,3]
//   output : conv6_out_i8, CHW 128x16x16
module animals10_conv6_systolic_4x4 (
    input logic clk,
    input logic rst_n,
...
endmodule : animals10_conv6_systolic_4x4
