...
// Animals-10 Student A Conv3 through the generic SIZE=4 systolic Conv engine.
//
// Contract:
//   input  : pool1_out_i8, CHW 32x32x32
//   weight : compact Conv3 OIHW [64,32,3,3]
//   output : conv3_out_i8, CHW 64x32x32
module animals10_conv3_systolic_4x4 (
    input logic clk,
    input logic rst_n,
...
endmodule : animals10_conv3_systolic_4x4
