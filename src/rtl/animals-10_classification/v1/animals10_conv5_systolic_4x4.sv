...
// Animals-10 Student A Conv5 through the generic SIZE=4 systolic Conv engine.
//
// Contract:
//   input  : pool2_out_i8, CHW 64x16x16
//   weight : compact Conv5 OIHW [128,64,3,3]
//   output : conv5_out_i8, CHW 128x16x16
module animals10_conv5_systolic_4x4 (
    input logic clk,
    input logic rst_n,
    ...
    input logic [16:0] weight_addr_i,
...
endmodule : animals10_conv5_systolic_4x4
