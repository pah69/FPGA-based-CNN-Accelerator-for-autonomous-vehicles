...
// Animals-10 Student A Conv2 through the generic SIZE=4 systolic Conv engine.
//
// Contract:
//   input  : conv1_out_i8, CHW 32x64x64
//   weight : compact Conv2 OIHW [32,32,3,3]
//   output : conv2_out_i8, CHW 32x64x64
module animals10_conv2_systolic_4x4 (
    input logic clk,
    input logic rst_n,
    ...
    output logic [16:0] output_index_o,
...
endmodule : animals10_conv2_systolic_4x4
