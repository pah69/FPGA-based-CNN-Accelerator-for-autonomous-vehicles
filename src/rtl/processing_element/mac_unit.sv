...
module mac_unit #(
    ...
    // Data inputs
    input logic signed [DATA_WIDTH-1:0] mac_a_in,
    input logic signed [DATA_WIDTH-1:0] mac_b_in,
  ...
  // --- Internal Signals ---
  logic signed [(DATA_WIDTH*2)-1:0] product_out;
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      valid_pipe <= {valid_pipe[1:0], mac_valid_in};
  ...
  accumulator #(
      ...
      .accum_in({product_out[(DATA_WIDTH*2)-1], product_out}),
