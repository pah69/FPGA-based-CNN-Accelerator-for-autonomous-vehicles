...
module top #(
    ...
    output logic [(32*DBG_PREFETCH_COUNT)-1:0] dbg_conv1_prefetch_counts_flat_o,
    output logic [(32*DBG_PREFETCH_COUNT)-1:0] dbg_conv2_prefetch_counts_flat_o,
    output logic [(32*DBG_PREFETCH_COUNT)-1:0] dbg_fc1_prefetch_counts_flat_o,
    output logic [(32*DBG_PREFETCH_COUNT)-1:0] dbg_fc2_prefetch_counts_flat_o,
  ...
  logic ub_rd_valid_w;
  logic ub_rd_packed_en_w;
  logic ub_rd_packed_bank_w;
  logic [UB_ADDR_WIDTH-1:0] ub_rd_packed_addr_w;
  logic signed [(DATA_WIDTH*SIZE)-1:0] ub_rd_packed_data_w;
  logic ub_rd_packed_valid_w;
  logic ub_wr_en_w;
  logic ub_wr_bank_w;
  ...
  logic layer_ub_rd_packed_en_w;
  logic layer_ub_rd_packed_bank_w;
  logic [UB_ADDR_WIDTH-1:0] layer_ub_rd_packed_addr_w;
  ...
  always_comb begin
    if (host_access_w) begin
      ...
      ub_rd_packed_en_w = 1'b0;
      ub_rd_packed_bank_w = 1'b0;
      ub_rd_packed_addr_w = '0;
      ...
      ub_rd_packed_en_w = layer_ub_rd_packed_en_w;
      ub_rd_packed_bank_w = layer_ub_rd_packed_bank_w;
      ub_rd_packed_addr_w = layer_ub_rd_packed_addr_w;
  ...
  unified_buffer #(
      ...
      .rd_packed_en_i   (ub_rd_packed_en_w),
      .rd_packed_bank_i (ub_rd_packed_bank_w),
      .rd_packed_addr_i (ub_rd_packed_addr_w),
      .rd_packed_data_o (ub_rd_packed_data_w),
      .rd_packed_valid_o(ub_rd_packed_valid_w),
      .wr_en_i   (ub_wr_en_w),
  ...
  controller_layer #(
      ...
      .ub_rd_packed_en_o               (layer_ub_rd_packed_en_w),
      .ub_rd_packed_bank_o             (layer_ub_rd_packed_bank_w),
      .ub_rd_packed_addr_o             (layer_ub_rd_packed_addr_w),
      .ub_rd_packed_data_i             (ub_rd_packed_data_w),
      .ub_rd_packed_valid_i            (ub_rd_packed_valid_w),
  ...
  datapath #(
      ...
      .fc_local_accum_mode_i           (layer_active_w && (layer_idx_w == LAYER_IDX_FC1)),
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      dbg_conv1_prefetch_counts_flat_o <= '0;
      dbg_conv2_prefetch_counts_flat_o <= '0;
      dbg_fc1_prefetch_counts_flat_o <= '0;
      dbg_fc2_prefetch_counts_flat_o <= '0;
      ...
      unique case (state_q)
        ...
        S_RUN_FC1: begin
          if (layer_error_w) begin
            ...
            dbg_fc1_prefetch_counts_flat_o <= layer_prefetch_counts_flat_w;
            state_q <= S_START_FC2;
          end
        end
        ...
        S_RUN_FC2: begin
          if (layer_error_w) begin
            ...
            dbg_fc2_prefetch_counts_flat_o <= layer_prefetch_counts_flat_w;
            state_q <= S_DONE;
          end
        end
