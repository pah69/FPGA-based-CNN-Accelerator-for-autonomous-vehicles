...
#ifdef XPAR_TPU_ZYBO_0_BASEADDR
#define TPU_BASEADDR XPAR_TPU_ZYBO_0_BASEADDR
#elif defined(XPAR_TPU_MNIST_0_BASEADDR)
#define TPU_BASEADDR XPAR_TPU_MNIST_0_BASEADDR
#else
#define TPU_BASEADDR 0x40000000U
#endif
...
#define TPU_STATUS_TOP_DONE     0x00010000U
