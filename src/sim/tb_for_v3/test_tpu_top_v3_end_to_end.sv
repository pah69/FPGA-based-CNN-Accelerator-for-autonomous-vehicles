...
module test_tpu_top_v3_end_to_end;
  ...
  tpu_top #(
      ...
      .WGT_INIT_FILE      ("../../rtl/v3/small_cnn_sym_weights_i8.mem"),
  ...
  initial begin
    ...
    $display("test_tpu_top_v3_end_to_end: checks=%0d pass=%0d fail=%0d",
             test_count, pass_count, fail_count);
    if (fail_count != 0) begin
      $fatal(1, "test_tpu_top_v3_end_to_end failed");
    end
    $finish;
  end

endmodule : test_tpu_top_v3_end_to_end
